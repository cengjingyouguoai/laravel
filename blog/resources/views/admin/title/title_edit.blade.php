                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{ url('admin/title/title_edit_deal') }}">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">座右铭标题</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">座右铭内容</label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">座右铭排序</label>
