    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
           ...
           <li>
             ...
             <li>
                  <a href=""><i class="fa fa-edit"></i> <span class="nav-label">个人名片</span><span class="fa arrow"></span></a>
                  <ul class="nav nav-second-level">
                      <li><a href="{{ url('admin/card/card_list') }}">名片列表</a>
                      </li>
                      <li><a href="{{ url('admin/card/card_edit') }}">名片增加</a>
                      </li>
                  </ul>
              </li>
            {{--    <li>
